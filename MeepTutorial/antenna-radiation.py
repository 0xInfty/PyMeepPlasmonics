...
# -*- coding: utf-8 -*-
"""
Radiation pattern of an electric-current point dipole antenna emitter in vacuum
"""
...
sxy = 4 # width of actual simulation box in um
dpml = 1 # width of PML layer in um
cell = mp.Vector3(sxy+2*dpml, sxy+2*dpml)

pml_layers = [mp.PML(dpml)]

fcen = 1.0 # Source has mid wavelenth 1000 nm in the IR.
df = 0.4
src_cmpt = mp.Ex
...
# The experiment could be repeated for the three polarizations.
if src_cmpt == mp.Ex:
