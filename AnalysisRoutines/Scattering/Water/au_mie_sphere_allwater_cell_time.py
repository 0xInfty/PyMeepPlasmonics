...
series_label = [lambda s : trs.choose(rf"First time x{vu.find_numbers(s)[test_param_position]:.1f}",
                                      rf"Primer Tiempo x{vu.find_numbers(s)[test_param_position]:.1f}")]*2
