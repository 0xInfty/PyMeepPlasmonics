...
# Saving directories
folder = ["Scattering/AuSphere/AllWatTest/9)BoxDimensions/WLenMax"]
home = vs.get_home()

# Parameter for the test
test_param_string = "max_wlen_range"
...
test_param_name = trs.choose("Wavelength Range Maximum ", 
                             "Máximo del rango de longitud de onda ") + r"$\Delta\lambda_{max}$"
test_param_units = "nm" # Leave "" by default

# Sorting and labelling data series
sorting_function = [lambda l : vu.sort_by_number(l, test_param_position)]*2
series_label = trs.choose([lambda s : rf"Maximum $\Delta\lambda$ {vu.find_numbers(s)[test_param_position]:.0f} nm"]*2,
                          [lambda s : rf"Máximo $\Delta\lambda$ {vu.find_numbers(s)[test_param_position]:.0f} nm"]*2)
...
plot_folder = "DataAnalysis/Scattering/AuSphere/AllWaterTest/MaxWlen"
