...
@cli.option("--normalize", "-norm", "normalize", type=bool, default=False,
            help="Whether to also run with an empty cell or not")
...
def main(from_um_factor, resolution, courant,
         ...
         time_period_factor, norm_time_period_factor,
         series, folder,
         n_cores, n_nodes, split_chunks_evenly,
         normalize, hfield, make_plots, make_gifs):
    ...
    norm_until_time = norm_time_period_factor * wlen
    ...
    params_list = ["from_um_factor", "resolution", "courant",
                   ...
                   "until_time", "time_period_factor", "norm_time_period_factor",
                   "n_period_line", "n_period_plane", "period_line", "period_plane",
                   "parallel", "n_processes", "n_cores", "n_nodes",
                   "split_chunks_evenly", "normalize", "hfield",
                   "script", "sysname", "path"]
    ...
    #%% PLOT CELL
        ...
        if pm.assign(0):
            ...
            files = ["Field-Lines-Norm", "Field-Planes-Norm"]
            ...
            if hfield:
                ...
                hfiles = ["Field-HLines-Norm", "Field-HPlanes-Norm"]
        ...
        rm.save(sa.file("Resources-Norm.h5"), params)
