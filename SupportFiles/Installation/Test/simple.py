...
#f = h5.File("/nfs/home/vpais/ThesisResults/TestParallel.h5", "w", driver="mpio", comm=comm)
f = h5.File("/nfs/home/vpais/ThesisResults/TestParallel.h5", "w", driver="mpio", comm=MPI.COMM_WORLD)
